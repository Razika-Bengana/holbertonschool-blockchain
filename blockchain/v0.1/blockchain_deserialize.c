...
/**
 * open_and_verify_file - program that opens and verifies a file
 * for blockchain deserialization
 *
 * this function opens a file at the specified path and verifies
 * the header information to ensure it's a valid blockchain file
 *
 * @path: the path to the file to open and verify
 *
 * Return: a FILE pointer to the opened file upon success,
...
/**
 * read_blocks_and_build_blockchain - program that reads blocks from a file
 * and builds a blockchain
 *
 * this function reads block data from the provided file and constructs
 * a blockchain structure based on the information read
 *
 * @file: the FILE pointer to the file containing block data
 *
 * Return: a pointer to the constructed blockchain upon success,
 *         or NULL upon failure
 */
 ...
 *
 * this function deserializes a Blockchain from a file by opening and
 * verifying the file, reading block data, and building the blockchain
 * structure
 *
